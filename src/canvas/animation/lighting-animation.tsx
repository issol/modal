...
const StageLightingWaveAnimation: React.FC<StageLightingWaveAnimationProps> = ({ canvasWidth, canvasHeight }) => {
  ...
  return <canvas ref={canvasRef} onClick={() => router.push('/modal-page')} />;
};
